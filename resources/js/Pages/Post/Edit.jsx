                        ...
                        <div className="sm:px-6 lg:px-8">
                            <div className="bg-white overflow-hidden">
                                <form onSubmit={handleSubmit}
                                    ...
                                    <div className="flex p-1 space-between">
                                    	<Link className="p-3 bg-blue-500 text-white hover:bg-blue-400"
                                            as="button" method="DELETE" href={route("post.deleye",post)}>Delete</Link>
